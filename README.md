...
**Booksy Scraper** — Booksy Scraper - Collect public beauty and wellness business listings, services, and review signals

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/booksy-scraper?style=social)
...
>
> **Search intent:** collect public Booksy data for account research, CRM enrichment, and lead qualification. Related topics: local business data, beauty business data, review data, python, data extraction.

## What this project is for

`booksy-scraper` is an implementation-focused Python project for collecting public Booksy data. It is designed around one practical job: turn a query such as **"B2B SaaS companies"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/booksy-scraper.git
cd booksy-scraper
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "Booksy", "category": "Local Business Scrapers"}
  }
}
```
